...
void draw_menu(uint16_t mode){
    ...
    draw_menu_words(mode);
}
void draw_menu_words(uint16_t mode){
    switch(menu_selection){
        case START:
            draw_small_xpm((xpm_map_t)selected_s_xpm, 400, 200, mode);
            draw_small_xpm((xpm_map_t)selected_t_xpm, 415, 200, mode);
            draw_small_xpm((xpm_map_t)selected_a_xpm, 430, 200, mode);
            draw_small_xpm((xpm_map_t)selected_r_xpm, 445, 200, mode);
            draw_small_xpm((xpm_map_t)selected_t_xpm, 460, 200, mode);
        ...
        case EXIT:
            ...
            draw_small_xpm((xpm_map_t)selected_q_xpm, 406, 230, mode);
            draw_small_xpm((xpm_map_t)selected_u_xpm, 421, 230, mode);
            draw_small_xpm((xpm_map_t)selected_i_xpm, 436, 230, mode);
            draw_small_xpm((xpm_map_t)selected_t_xpm, 451, 230, mode);
            break;
        default:
            break;
    }
